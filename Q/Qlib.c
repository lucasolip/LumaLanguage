...
// void putfloat(const unsigned char*, int)
// Entrada: R0=etiqueta de retorno
//          R1=dirección de la ristra de formato
//          R2=valor flotante a visualizar (opcional según formato)
// No modifica ningún registro ni la ristra de formato
L putfloat_: {unsigned char *p=inv_str(&U(R1)); // invierte: nva. dir. real 1er char
